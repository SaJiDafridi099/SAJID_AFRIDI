...
\ `--.  __ _    | |_| | | | |_   
 `--. \/ _` |   | | | | | |  _|  
/\__/ / (_| /\__/ / | |/ /| |    
\____/ \__,_\____/|_|___/ \_|    
                      ______     
                     |______|    

\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m𝙈𝙧 I_F_LOVE
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+92320×××××
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m SaJiD x Faixo 
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #sajid
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/FTSaJiDoO")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [sajid] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
